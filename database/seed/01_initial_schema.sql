...
CREATE TABLE IF NOT EXISTS video_jobs (
    ...
    video_type VARCHAR(50) DEFAULT 'cinematic',
    duration INT DEFAULT 30,
    aspect_ratio VARCHAR(20) DEFAULT '16:9',
    resolution VARCHAR(20) DEFAULT '1080p',
    visual_style VARCHAR(100) DEFAULT 'Cinematic',
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'Planning', -- Planning, DraftStoryboard, Generating, Normalizing, Merging, Completed, Failed
...
CREATE TABLE IF NOT EXISTS scenes (
    ...
    status VARCHAR(50) DEFAULT 'Pending', -- Pending, Generating, Downloaded, Normalized, ReadyForMerge, Failed
...
VALUES (
    ...
    'cinematic',
    30
) ON CONFLICT (id) DO NOTHING;NFLICT (id) DO NOTHING;
